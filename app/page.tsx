...
export default function HomePage() {
  return (
    <div className="space-y-16 pb-16">
      {/* HERO DA HOMEPAGE - REFERÊNCIA */}
      <section className="relative overflow-hidden border-b border-[#E2E8F0] dark:border-[#1E293B] bg-[#F8FAFC] dark:bg-[#0F172A]/50 pt-12 pb-16 sm:pt-16 sm:pb-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#0F172A] dark:text-white leading-[1.15]">
              ...
              <p className="text-base sm:text-lg text-[#475569] dark:text-[#94A3B8] leading-relaxed max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3.5 pt-2">
                <Link
                  href="/ferramentas"
                  className="rounded-xl bg-[#2563EB] px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-[#1D4ED8] active:scale-[0.98] transition-all cursor-pointer"
                >
                  Explorar ferramentas
                </Link>
                <Link
                  href="/#populares"
                  className="rounded-xl border border-[#E2E8F0] dark:border-[#334155] bg-white dark:bg-[#1E293B] px-6 py-3 text-sm font-semibold text-[#0F172A] dark:text-white shadow-2xs hover:bg-[#F8FAFC] dark:hover:bg-[#0F172A] hover:border-[#CBD5E1] dark:hover:border-[#475569] active:scale-[0.98] transition-all cursor-pointer"
                >
                  Mais usadas
                </Link>
              </div>
              ...
              <div className="pt-4 max-w-xl mx-auto lg:mx-0">
                ...
                <div className="mt-3 flex flex-wrap items-center justify-center lg:justify-start gap-2 text-xs text-[#64748B] dark:text-[#94A3B8]">
            ...
            {/* Coluna Direita: Mockup Visual das Ferramentas (Como na referência) */}
      ...
      <section id="populares" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 gap-4 border-b border-[#E2E8F0] dark:border-[#1E293B] pb-4">
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-[#0F172A] dark:text-white sm:text-3xl">
          ...
          <Link
            href="/ferramentas"
            className="flex items-center gap-1 text-sm font-semibold text-[#2563EB] dark:text-[#38BDF8] hover:text-[#1D4ED8] dark:hover:text-[#7DD3FC] hover:gap-2 transition-all shrink-0"
          >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-[#E2E8F0] dark:border-[#334155] bg-white dark:bg-[#1E293B] p-8 sm:p-12 shadow-sm">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white sm:text-3xl">
              Por que usar o Crie Grátis?
            </h2>
            <p className="mt-2 text-[#475569] dark:text-[#94A3B8] text-sm sm:text-base">
              Desenvolvemos a plataforma com foco em simplicidade, velocidade e privacidade total.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            <div className="flex flex-col items-center text-center space-y-3 p-6 rounded-2xl bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155]">
              ...
              <h3 className="text-base font-bold text-[#0F172A] dark:text-white">Privacidade em 1.º Lugar</h3>
            ...
            <div className="flex flex-col items-center text-center space-y-3 p-6 rounded-2xl bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155]">
              ...
              <h3 className="text-base font-bold text-[#0F172A] dark:text-white">Velocidade Instantânea</h3>
              <p className="text-xs sm:text-sm text-[#475569] dark:text-[#94A3B8] leading-relaxed">
            ...
            <div className="flex flex-col items-center text-center space-y-3 p-6 rounded-2xl bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155]">
              ...
              <h3 className="text-base font-bold text-[#0F172A] dark:text-white">Totalmente Grátis</h3>
              <p className="text-xs sm:text-sm text-[#475569] dark:text-[#94A3B8] leading-relaxed">
